...
namespace Third
{
    class Program
    {
        ...
        //ЦИКЛЫ
        //For работаем сточными значеними и знаем сколько раз он выполнится.
        //While не знаем сколько рз будет выполняться ивыполняется пока соблюдены условия
        //Do While Выполнится хотя бы один раз
        //Recurce имеем дело с деревом оъектов
        //foreach используется когда нам нужно обработать все объекты массива или перечисления
